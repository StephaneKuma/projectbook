...
@section('content')
    <div class="row">
        <div class="col-md-2">
            <a href="{{ route('admin.roles.create') }}" class="btn btn-block btn-primary"><i class="fa fa-bars"></i> {{ _("Gérer les rôles") }}</a>
        </div>
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form class="row" action="{{ route('admin.users.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="last_name" name="last_name" value="{{ old('last_name') }}" required autofocus placeholder="{{ _('Nom de famille') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="first_name" name="first_name" value="{{ old('first_name') }}" required placeholder="{{ _('Votre/vos prénom(s)') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="pseudo" name="pseudo" value="{{ old('pseudo') }}" required placeholder="{{ _('Pseudonyme') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email" name="email" value="{{ old('email') }}" required placeholder="{{ _('xxxxxxx@xxx.com') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="password" type="password" class="form-control" name="password" required autocomplete="new-password" placeholder="{{ _('Votre mot de passe') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="{{ _('Retapez le mot de passe') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
