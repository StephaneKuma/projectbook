...
@section('content')
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form class="row" action="{{ route('admin.sectors.store') }}" method="post">
                        @csrf
                            ...
                            <div class="row">
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="label" name="label" value="{{ old('label') }}" required autofocus placeholder="{{ _('Achronyme') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6 pr-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="first_name" name="sector_name" value="{{ old('sector_name') }}" required placeholder="{{ _('Nom complet') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
